...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Block Tales Wiki",
    description: "Read the Terms of Service for Block Tales Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox RPG resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Block Tales Wiki",
      description: "Terms and conditions for using Block Tales Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Block Tales Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Block Tales Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Block Tales Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Block Tales Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Roblox RPG "Block Tales". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Chapter walkthroughs and beginner guides</li>
              <li>Card, item, and BUX location references</li>
              <li>Boss and mini-boss strategy guides</li>
              <li>Badge and hidden badge walkthroughs</li>
              <li>Updates, patch notes, and community resources</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Block Tales Wiki is NOT affiliated with, endorsed by, or associated with
              Roblox Corporation, Spaceman Moonbase, or any official Block Tales entities. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Block Tales Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Roblox Corporation, Spaceman Moonbase, and/or their respective owners. We use such
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, BLOCK TALES WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Block Tales Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@block-tales.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@block-tales.wiki</a>
            </p>
            <p>
